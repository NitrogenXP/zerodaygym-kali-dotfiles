...
-- Comment out vim-with-me keymaps since plugin is not available
...
-- Toggle Supermaven on/off with <leader>sm
...
-- Map <leader>ch to prompt for a Copilot Chat question
vim.keymap.set({'n', 'v'}, "<leader>ch", function()
  local question = vim.fn.input("Copilot Chat: ")
  if question ~= "" then
    vim.cmd("CopilotChat " .. question)
  end
end, { desc = "Ask Copilot Chat" })

-- Map lsp diagnostic show full window
